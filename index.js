...
// selecting a user from a list of user
...
let attempts = 0;
let findUser = (colors.bold.brightBlue(prompt(`Let's write down your name: `)));
if(!findUser){
  while(attempts<2){
  findUser = (colors.bold.brightBlue(prompt(`Let's write down your name: `)));
  attempts++
  }
  console.log()
...
// collecting user preference of game + while loop for reinititializing the function when required,e g: user wants to play 2nd round
 ...
 console.log()
  if(!input){
    while(attempts<2){
      input = prompt(`Please choose a category: `).toLowerCase();
      attempts++
    }
    console.log()
  console.log("Thank you for choosing Quiz-game, you are now exiting the game")
  ...
  let level = prompt(`Your choice: `).toLowerCase();
  console.log()
  if(!level){
    while(attempts<2){
     level = prompt(`Please choose difficulty level: `).toLowerCase();
      attempts++
    }
    console.log()
  console.log("Thank you for choosing Quiz-game, you are now exiting the game")
  ...
  const questions = [
...

    {
      ...
      difficulty: 2,
      question:
        "Which particle is responsible for carrying an electrical charge in an atom's nucleus?",
...

    {
      ...
      difficulty: 3,
      question:
        "What is the Heisenberg Uncertainty Principle, and how does it relate to quantum mechanics?",
      choices: [
...

    {
      ...
      difficulty: 3,
      question:
        "What is the Higgs boson, and why is its discovery significant in the field of particle physics?",
      choices: [
...

    {
      ...
      difficulty: 3,
      question:
        "Explain the concept of Schrödinger's cat in quantum physics and the implications of the thought experiment.",
      choices: [
...

    {
      ...
      difficulty: 3,
      question:
        "What is the concept of quantum entanglement, and how does it challenge our understanding of particle physics?",
      choices: [
...

    {
      ...
      difficulty: 3,
      question:
        "What is the Fermi Paradox, and what are some proposed solutions or explanations for it?",
      choices: [
...

    {
      ...
      difficulty: 1,
      question:
        "What was Mussolini's, who founded the National Fascist Pary of Italy, first name? ",
...

    {
      ...
      difficulty: 3,
      question:
        "What were the main causes and consequences of the Peloponnesian War in ancient Greece?",
      choices: [
...

    {
      ...
      difficulty: 3,
      question:
        "Explain the impact of the Industrial Revolution on society, economy, and politics in the 18th and 19th centuries.",
      choices: [
...

    {
      ...
      difficulty: 3,
      question:
        "Discuss the major factors and consequences of the Cuban Missile Crisis during the Cold War.",
      choices: [
    ...
    },
    {
      ...
      difficulty: 3,
      question:
        "Examine the causes and consequences of the Treaty of Versailles following World War I.",
      choices: [
...

    {
      ...
      difficulty: 3,
      question:
        "Discuss the impact of the Renaissance period on art, culture, and science in Europe during the 14th to 17th centuries.",
      choices: [
...

    {
      ...
      difficulty: 1,
      question:
        "Which director was the creative mind behind Pulp Fiction, Django Unchained and Kill Bill? ",
...

    {
      ...
      difficulty: 1,
      question:
        "Which of the following historical events is not mentioned in Forrest Gump?",
      choices: [
...

    {
      ...
      difficulty: 2,
      question:
        "Which British author is famous for creating the 'Harry Potter' book series?",
      choices: [
        "J.K. Rowling",
        "George Orwell",
        "Charles Dickens",
...

    {
      ...
      difficulty: 2,
      question:
        "Which animated film features a young lion named Simba as the main character?",
      choices: [
        "The Little Mermaid",
...

    {
      ...
      difficulty: 2,
      question:
        "Which famous rock band released the album 'The Dark Side of the Moon'?",
      choices: [
        "The Beatles",
        "Led Zeppelin",
        "Pink Floyd",
...

    {
      ...
      difficulty: 2,
      question:
        "Which actor played the iconic character James Bond in the film 'Casino Royale' (2006)?",
      choices: [
        "Pierce Brosnan",
        "Daniel Craig",
        "Roger Moore",
...

    {
      ...
      difficulty: 3,
      question:
        "In film history, what is the significance of the French New Wave movement, and who were some notable directors associated with it?",
      choices: [
...

    {
      ...
      difficulty: 3,
      question:
        "What is the concept of auteur theory in filmmaking, and how does it influence the interpretation of a director's work?",
      choices: [
...

    {
      ...
      difficulty: 3,
      question:
        "What is the concept of method acting, and which famous actors are known for practicing it in their performances?",
      choices: [
...

    {
      ...
      difficulty: 3,
      question:
        "Discuss the role of streaming platforms in changing the landscape of television and film consumption. How have these platforms influenced content creation, viewer preferences, and the traditional TV and movie industry?",
      choices: [
...

    {
      ...
      difficulty: 3,
      question:
        "How has the digital age influenced the gaming industry, particularly in the context of virtual reality (VR) technology, and what implications has it had for gameplay experiences?",
      choices: [
  ...
  //filtering the question according to user preference category and level, returning a array of selected question object
  function filteredQuestions(input, level) {
    return questions.filter(
      (question) =>
        question.id === parseInt(input) &&
        question.difficulty === parseInt(level)
    );
  }

  const selectedQuestion = filteredQuestions(input, level);
  // randomizing the filtered array to appear questions randomly
  function randomizeQuestion() {
    const randomIndex = Math.floor(Math.random() * selectedQuestion.length);
    const pickedQuestion = selectedQuestion.splice(randomIndex, 1)[0]; //splice gives a new array of pickedup element from the original array. [0] put the picked up element in the first position of the new array.
    return pickedQuestion; ///its an array of picked up questions
  }
  ...
  while (selectedQuestion.length > 0) {
    ...
    console.log();
    ///getting user input for answering each question
    const answer = prompt(`Your answer is: `);
    ///checking whether users' answers are correct ones rint message accordinly
    if (parseInt(answer) === chosenQuestions.correctAnswer) {
      score++;
      console.log(`Correct!`.cyan);
      console.log();
    }
  ...
  // setting a message when no more question to ask from the users choice
  console.log(`${findUser} Your final score is: ${score}\n`);
  const percentage = (score / count) * 100;
  if (score >= 0.5 * count) {
    console.log(
      `Congratulations, with ${percentage}% final result you have access to the next level  `
    );
    //play again
    ...
    console.log(
      `Your ${percentage}% is not a bad result but you have to get better at this level before jumping on the next one. Don't give up!!`
    );
    console.log();
    console.log("\x1b[34m\n----------Game Over---------\n\x1b[0m");
